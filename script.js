...
const ShowMsgs=()=>{
    ...
    if(arr1[0]==ph && arr1[1]==a.innerText){
        ...
        document.getElementById("timeMsg2").innerHTML="<h2>Hey, It's Time To Wake Up. </h2>"
        ...
        document.getElementById("timeMsg2").innerHTML="<h2>It's Time to take a nap</h2>"
        ...
        document.getElementById("timeMsg2").innerHTML="<h2>It's time to take a rest and sleep.</h2>"
        ...
        document.getElementById("timeMsg1").innerText="WELCOME! Adarsh"
        document.getElementById("timeMsg2").innerHTML="<h2>Set Time and Click on Button to Start Alarm.</h2>"
        document.getElementById('images').style.backgroundImage = "url('./assets/time.webp')"
        document.getElementById('images').style.backgroundRepeat = "no-repeat"
        document.getElementById('images').style.backgroundSize = "cover"
